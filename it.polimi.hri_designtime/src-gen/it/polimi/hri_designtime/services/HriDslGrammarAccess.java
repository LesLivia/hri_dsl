...
public class HriDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class SurfaceElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cRectangular_surfaceKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		private final RuleCall cVerticesVerticesParserRuleCall_4_0 = (RuleCall)cVerticesAssignment_4.eContents().get(0);
		...
		//'rectangular_surface'
		public Keyword getRectangular_surfaceKeyword_1() { return cRectangular_surfaceKeyword_1; }
		...
		//Vertices
		public RuleCall getVerticesVerticesParserRuleCall_4_0() { return cVerticesVerticesParserRuleCall_4_0; }
	}
	public class VerticesElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cCoordinates_vertex_AKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cVertex_AAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cVertex_ACoordinatesParserRuleCall_1_0 = (RuleCall)cVertex_AAssignment_1.eContents().get(0);
		private final Keyword cCoordinates_vertex_CKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cVertex_CAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cVertex_CCoordinatesParserRuleCall_3_0 = (RuleCall)cVertex_CAssignment_3.eContents().get(0);
		...
		public Keyword getCoordinates_vertex_AKeyword_0() { return cCoordinates_vertex_AKeyword_0; }
		
		//vertex_A=Coordinates
		public Assignment getVertex_AAssignment_1() { return cVertex_AAssignment_1; }
		
		//Coordinates
		public RuleCall getVertex_ACoordinatesParserRuleCall_1_0() { return cVertex_ACoordinatesParserRuleCall_1_0; }
		
		//'coordinates_vertex_C'
		public Keyword getCoordinates_vertex_CKeyword_2() { return cCoordinates_vertex_CKeyword_2; }
		
		//vertex_C=Coordinates
		public Assignment getVertex_CAssignment_3() { return cVertex_CAssignment_3; }
		
		//Coordinates
		public RuleCall getVertex_CCoordinatesParserRuleCall_3_0() { return cVertex_CCoordinatesParserRuleCall_3_0; }
	}
	public class PointElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cAddKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cPoint_of_interestKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameIDTerminalRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		private final Keyword cWithKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//'point_of_interest'
		public Keyword getPoint_of_interestKeyword_1() { return cPoint_of_interestKeyword_1; }
	...
	public class RobotElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cCoordinatesKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cCoordinatesAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cCoordinatesCoordinatesParserRuleCall_4_0 = (RuleCall)cCoordinatesAssignment_4.eContents().get(0);
		...
		private final Keyword cCharge_percentageKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Assignment cCharge_percentageAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cCharge_percentageINTTerminalRuleCall_8_0 = (RuleCall)cCharge_percentageAssignment_8.eContents().get(0);
		...
		//'coordinates'
		public Keyword getCoordinatesKeyword_3() { return cCoordinatesKeyword_3; }
		
		//coordinates=Coordinates
		public Assignment getCoordinatesAssignment_4() { return cCoordinatesAssignment_4; }
		
		//Coordinates
		public RuleCall getCoordinatesCoordinatesParserRuleCall_4_0() { return cCoordinatesCoordinatesParserRuleCall_4_0; }
		...
		//'charge_percentage'
		public Keyword getCharge_percentageKeyword_7() { return cCharge_percentageKeyword_7; }
		
		//charge_percentage=INT
		public Assignment getCharge_percentageAssignment_8() { return cCharge_percentageAssignment_8; }
		
		//INT
		public RuleCall getCharge_percentageINTTerminalRuleCall_8_0() { return cCharge_percentageINTTerminalRuleCall_8_0; }
	}
	...
	public class HumanElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cSpeedFLOATTerminalRuleCall_6_0 = (RuleCall)cSpeedAssignment_6.eContents().get(0);
		private final Keyword cDexterityKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Assignment cDextAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cDextINTTerminalRuleCall_8_0 = (RuleCall)cDextAssignment_8.eContents().get(0);
		private final Keyword cFatigue_profileKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cFatigue_profileAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cFatigue_profileFatigue_profileEnumRuleCall_10_0 = (RuleCall)cFatigue_profileAssignment_10.eContents().get(0);
		private final Keyword cFree_will_profileKeyword_11 = (Keyword)cGroup.eContents().get(11);
		private final Assignment cFree_will_profileAssignment_12 = (Assignment)cGroup.eContents().get(12);
		private final RuleCall cFree_will_profileFree_will_profileEnumRuleCall_12_0 = (RuleCall)cFree_will_profileAssignment_12.eContents().get(0);
		...
		//FLOAT
		public RuleCall getSpeedFLOATTerminalRuleCall_6_0() { return cSpeedFLOATTerminalRuleCall_6_0; }
		
		//'dexterity'
		public Keyword getDexterityKeyword_7() { return cDexterityKeyword_7; }
		
		//dext=INT
		public Assignment getDextAssignment_8() { return cDextAssignment_8; }
		
		//INT
		public RuleCall getDextINTTerminalRuleCall_8_0() { return cDextINTTerminalRuleCall_8_0; }
		
		//'fatigue_profile'
		public Keyword getFatigue_profileKeyword_9() { return cFatigue_profileKeyword_9; }
		
		//fatigue_profile=Fatigue_profile
		public Assignment getFatigue_profileAssignment_10() { return cFatigue_profileAssignment_10; }
		
		//Fatigue_profile
		public RuleCall getFatigue_profileFatigue_profileEnumRuleCall_10_0() { return cFatigue_profileFatigue_profileEnumRuleCall_10_0; }
		
		//'free_will_profile'
		public Keyword getFree_will_profileKeyword_11() { return cFree_will_profileKeyword_11; }
		
		//free_will_profile=Free_will_profile
		public Assignment getFree_will_profileAssignment_12() { return cFree_will_profileAssignment_12; }
		
		//Free_will_profile
		public RuleCall getFree_will_profileFree_will_profileEnumRuleCall_12_0() { return cFree_will_profileFree_will_profileEnumRuleCall_12_0; }
	}
	...
	public class TypeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		...
		private final EnumLiteralDeclaration cTIAGOEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cTIAGOTiagoKeyword_1_0 = (Keyword)cTIAGOEnumLiteralDeclaration_1.eContents().get(0);
		private final EnumLiteralDeclaration cPEPPEREnumLiteralDeclaration_2 = (EnumLiteralDeclaration)cAlternatives.eContents().get(2);
		private final Keyword cPEPPERPepperKeyword_2_0 = (Keyword)cPEPPEREnumLiteralDeclaration_2.eContents().get(0);
		...
		//TIAGO='tiago'
		public EnumLiteralDeclaration getTIAGOEnumLiteralDeclaration_1() { return cTIAGOEnumLiteralDeclaration_1; }
		
		//'tiago'
		public Keyword getTIAGOTiagoKeyword_1_0() { return cTIAGOTiagoKeyword_1_0; }
		
		//PEPPER='pepper'
		public EnumLiteralDeclaration getPEPPEREnumLiteralDeclaration_2() { return cPEPPEREnumLiteralDeclaration_2; }
		
		//'pepper'
		public Keyword getPEPPERPepperKeyword_2_0() { return cPEPPERPepperKeyword_2_0; }
	}
