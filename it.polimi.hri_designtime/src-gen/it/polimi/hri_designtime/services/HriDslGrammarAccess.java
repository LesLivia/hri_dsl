...
public class HriDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cParameterKeyword_0_0 = (Keyword)cGroup_0.eContents().get(0);
		private final Keyword cLength_unitKeyword_0_1 = (Keyword)cGroup_0.eContents().get(1);
		private final Assignment cLength_unitAssignment_0_2 = (Assignment)cGroup_0.eContents().get(2);
		private final RuleCall cLength_unitLength_unitEnumRuleCall_0_2_0 = (RuleCall)cLength_unitAssignment_0_2.eContents().get(0);
		private final Group cGroup_1 = (Group)cUnorderedGroup.eContents().get(1);
		private final Keyword cParameterKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Keyword cFree_will_modelKeyword_1_1 = (Keyword)cGroup_1.eContents().get(1);
		private final Assignment cFree_will_modelAssignment_1_2 = (Assignment)cGroup_1.eContents().get(2);
		private final RuleCall cFree_will_modelBehavioral_modelEnumRuleCall_1_2_0 = (RuleCall)cFree_will_modelAssignment_1_2.eContents().get(0);
		
		// //prima era senza + davanti all'uguale per parameter
		//Parameter:
		...
		//'parameter'
		public Keyword getParameterKeyword_0_0() { return cParameterKeyword_0_0; }
		
		//'length_unit'
		public Keyword getLength_unitKeyword_0_1() { return cLength_unitKeyword_0_1; }
		
		//length_unit=Length_unit
		public Assignment getLength_unitAssignment_0_2() { return cLength_unitAssignment_0_2; }
		
		//Length_unit
		public RuleCall getLength_unitLength_unitEnumRuleCall_0_2_0() { return cLength_unitLength_unitEnumRuleCall_0_2_0; }
		
		//'parameter' 'free_will_model' free_will_model=Behavioral_model
		public Group getGroup_1() { return cGroup_1; }
		
		//'parameter'
		public Keyword getParameterKeyword_1_0() { return cParameterKeyword_1_0; }
		
		//'free_will_model'
		public Keyword getFree_will_modelKeyword_1_1() { return cFree_will_modelKeyword_1_1; }
		
		//free_will_model=Behavioral_model
		public Assignment getFree_will_modelAssignment_1_2() { return cFree_will_modelAssignment_1_2; }
		
		//Behavioral_model
		public RuleCall getFree_will_modelBehavioral_modelEnumRuleCall_1_2_0() { return cFree_will_modelBehavioral_modelEnumRuleCall_1_2_0; }
	}
	...
	public class Behavioral_modelElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "it.polimi.hri_designtime.HriDsl.Behavioral_model");
		...
		private final EnumLiteralDeclaration cERRORSEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cERRORSErrKeyword_1_0 = (Keyword)cERRORSEnumLiteralDeclaration_1.eContents().get(0);
		private final EnumLiteralDeclaration cCOG_V1EnumLiteralDeclaration_2 = (EnumLiteralDeclaration)cAlternatives.eContents().get(2);
		private final Keyword cCOG_V1Cog1Keyword_2_0 = (Keyword)cCOG_V1EnumLiteralDeclaration_2.eContents().get(0);
		private final EnumLiteralDeclaration cCOG_V2EnumLiteralDeclaration_3 = (EnumLiteralDeclaration)cAlternatives.eContents().get(3);
		private final Keyword cCOG_V2Cog2Keyword_3_0 = (Keyword)cCOG_V2EnumLiteralDeclaration_3.eContents().get(0);
		...
		//ERRORS = 'err'
		public EnumLiteralDeclaration getERRORSEnumLiteralDeclaration_1() { return cERRORSEnumLiteralDeclaration_1; }
		
		//'err'
		public Keyword getERRORSErrKeyword_1_0() { return cERRORSErrKeyword_1_0; }
		
		//COG_V1 = 'cog1'
		public EnumLiteralDeclaration getCOG_V1EnumLiteralDeclaration_2() { return cCOG_V1EnumLiteralDeclaration_2; }
		
		//'cog1'
		public Keyword getCOG_V1Cog1Keyword_2_0() { return cCOG_V1Cog1Keyword_2_0; }
		
		//COG_V2 = 'cog2'
		public EnumLiteralDeclaration getCOG_V2EnumLiteralDeclaration_3() { return cCOG_V2EnumLiteralDeclaration_3; }
		
		//'cog2'
		public Keyword getCOG_V2Cog2Keyword_3_0() { return cCOG_V2Cog2Keyword_3_0; }
	}
	...
	public class Free_will_profileElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		...
		private final EnumLiteralDeclaration cBUSYEnumLiteralDeclaration_4 = (EnumLiteralDeclaration)cAlternatives.eContents().get(4);
		private final Keyword cBUSYBusyKeyword_4_0 = (Keyword)cBUSYEnumLiteralDeclaration_4.eContents().get(0);
		private final EnumLiteralDeclaration cFREEEnumLiteralDeclaration_5 = (EnumLiteralDeclaration)cAlternatives.eContents().get(5);
		private final Keyword cFREEFreeKeyword_5_0 = (Keyword)cFREEEnumLiteralDeclaration_5.eContents().get(0);
		private final EnumLiteralDeclaration cUNEXPERIENCEDEnumLiteralDeclaration_6 = (EnumLiteralDeclaration)cAlternatives.eContents().get(6);
		private final Keyword cUNEXPERIENCEDUnexperiencedKeyword_6_0 = (Keyword)cUNEXPERIENCEDEnumLiteralDeclaration_6.eContents().get(0);
		private final EnumLiteralDeclaration cEXPERIENCEDEnumLiteralDeclaration_7 = (EnumLiteralDeclaration)cAlternatives.eContents().get(7);
		private final Keyword cEXPERIENCEDExperiencedKeyword_7_0 = (Keyword)cEXPERIENCEDEnumLiteralDeclaration_7.eContents().get(0);
		private final EnumLiteralDeclaration cCRITICALEnumLiteralDeclaration_8 = (EnumLiteralDeclaration)cAlternatives.eContents().get(8);
		private final Keyword cCRITICALCriticalKeyword_8_0 = (Keyword)cCRITICALEnumLiteralDeclaration_8.eContents().get(0);
		private final EnumLiteralDeclaration cSTABLEEnumLiteralDeclaration_9 = (EnumLiteralDeclaration)cAlternatives.eContents().get(9);
		private final Keyword cSTABLEStableKeyword_9_0 = (Keyword)cSTABLEEnumLiteralDeclaration_9.eContents().get(0);
		private final EnumLiteralDeclaration cDISTRACTEDEnumLiteralDeclaration_10 = (EnumLiteralDeclaration)cAlternatives.eContents().get(10);
		private final Keyword cDISTRACTEDDistractedKeyword_10_0 = (Keyword)cDISTRACTEDEnumLiteralDeclaration_10.eContents().get(0);
		private final EnumLiteralDeclaration cFOCUSEDEnumLiteralDeclaration_11 = (EnumLiteralDeclaration)cAlternatives.eContents().get(11);
		private final Keyword cFOCUSEDFocusedKeyword_11_0 = (Keyword)cFOCUSEDEnumLiteralDeclaration_11.eContents().get(0);
		...
		//BUSY= 'busy'
		public EnumLiteralDeclaration getBUSYEnumLiteralDeclaration_4() { return cBUSYEnumLiteralDeclaration_4; }
		
		//'busy'
		public Keyword getBUSYBusyKeyword_4_0() { return cBUSYBusyKeyword_4_0; }
		
		//FREE= 'free'
		public EnumLiteralDeclaration getFREEEnumLiteralDeclaration_5() { return cFREEEnumLiteralDeclaration_5; }
		
		//'free'
		public Keyword getFREEFreeKeyword_5_0() { return cFREEFreeKeyword_5_0; }
		
		//UNEXPERIENCED= 'unexperienced'
		public EnumLiteralDeclaration getUNEXPERIENCEDEnumLiteralDeclaration_6() { return cUNEXPERIENCEDEnumLiteralDeclaration_6; }
		
		//'unexperienced'
		public Keyword getUNEXPERIENCEDUnexperiencedKeyword_6_0() { return cUNEXPERIENCEDUnexperiencedKeyword_6_0; }
		
		//EXPERIENCED= 'experienced'
		public EnumLiteralDeclaration getEXPERIENCEDEnumLiteralDeclaration_7() { return cEXPERIENCEDEnumLiteralDeclaration_7; }
		
		//'experienced'
		public Keyword getEXPERIENCEDExperiencedKeyword_7_0() { return cEXPERIENCEDExperiencedKeyword_7_0; }
		
		//CRITICAL= 'critical'
		public EnumLiteralDeclaration getCRITICALEnumLiteralDeclaration_8() { return cCRITICALEnumLiteralDeclaration_8; }
		
		//'critical'
		public Keyword getCRITICALCriticalKeyword_8_0() { return cCRITICALCriticalKeyword_8_0; }
		
		//STABLE= 'stable'
		public EnumLiteralDeclaration getSTABLEEnumLiteralDeclaration_9() { return cSTABLEEnumLiteralDeclaration_9; }
		
		//'stable'
		public Keyword getSTABLEStableKeyword_9_0() { return cSTABLEStableKeyword_9_0; }
		
		//DISTRACTED= 'distracted'
		public EnumLiteralDeclaration getDISTRACTEDEnumLiteralDeclaration_10() { return cDISTRACTEDEnumLiteralDeclaration_10; }
		
		//'distracted'
		public Keyword getDISTRACTEDDistractedKeyword_10_0() { return cDISTRACTEDDistractedKeyword_10_0; }
		
		//FOCUSED= 'focused'
		public EnumLiteralDeclaration getFOCUSEDEnumLiteralDeclaration_11() { return cFOCUSEDEnumLiteralDeclaration_11; }
		
		//'focused'
		public Keyword getFOCUSEDFocusedKeyword_11_0() { return cFOCUSEDFocusedKeyword_11_0; }
	}
	...
	private final Behavioral_modelElements eBehavioral_model;
	...
	public HriDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.eBehavioral_model = new Behavioral_modelElements();
	...
	//    |COG_V1 = 'cog1'
	//    |COG_V2 = 'cog2';
	public Behavioral_modelElements getBehavioral_modelAccess() {
		return eBehavioral_model;
	}
	
	public EnumRule getBehavioral_modelRule() {
		return getBehavioral_modelAccess().getRule();
	}
