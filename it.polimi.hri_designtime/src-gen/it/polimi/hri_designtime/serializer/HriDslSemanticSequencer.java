...
public class HriDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Human(ISerializationContext context, Human semanticObject) {
		...
		feeder.accept(grammarAccess.getHumanAccess().getCoordinatesCoordinatesParserRuleCall_4_0(), semanticObject.getCoordinates());
		feeder.accept(grammarAccess.getHumanAccess().getSpeedFLOATTerminalRuleCall_6_0(), semanticObject.getSpeed());
		feeder.accept(grammarAccess.getHumanAccess().getDextINTTerminalRuleCall_8_0(), semanticObject.getDext());
		feeder.accept(grammarAccess.getHumanAccess().getFatigue_profileFatigue_profileEnumRuleCall_10_0(), semanticObject.getFatigue_profile());
		feeder.accept(grammarAccess.getHumanAccess().getFree_will_profileFree_will_profileEnumRuleCall_12_0(), semanticObject.getFree_will_profile());
		feeder.finish();
	}
	...
	protected void sequence_Point(ISerializationContext context, Point semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPointAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getPointAccess().getCoordinatesCoordinatesParserRuleCall_5_0(), semanticObject.getCoordinates());
		feeder.finish();
	}
	...
	protected void sequence_Robot(ISerializationContext context, Robot semanticObject) {
		...
		feeder.accept(grammarAccess.getRobotAccess().getCoordinatesCoordinatesParserRuleCall_4_0(), semanticObject.getCoordinates());
		feeder.accept(grammarAccess.getRobotAccess().getTypeTypeEnumRuleCall_6_0(), semanticObject.getType());
		feeder.accept(grammarAccess.getRobotAccess().getCharge_percentageINTTerminalRuleCall_8_0(), semanticObject.getCharge_percentage());
		feeder.finish();
	}
	...
	protected void sequence_Surface(ISerializationContext context, Surface semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSurfaceAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getSurfaceAccess().getVerticesVerticesParserRuleCall_4_0(), semanticObject.getVertices());
		feeder.finish();
	}
	...
	protected void sequence_Vertices(ISerializationContext context, Vertices semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVerticesAccess().getVertex_ACoordinatesParserRuleCall_1_0(), semanticObject.getVertex_A());
		feeder.accept(grammarAccess.getVerticesAccess().getVertex_CCoordinatesParserRuleCall_3_0(), semanticObject.getVertex_C());
		feeder.finish();
	}
